...
def build_plan(
    *,
    ...
    repo_id, parsed_revision = parse_hf_reference(reference, fallback_revision=revision)
    chosen_revision = revision if revision else parsed_revision
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--revision", default="main", help="Git revision/branch/tag to download")
